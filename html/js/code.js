...
document.getElementById('signUpCard').addEventListener('submit', function(event) {
    ...
    if (firstName.checkValidity() && lastName.checkValidity()&& !regex.test(firstName.value) && !regex.test(lastName.value) && userName.checkValidity() && password.checkValidity()) {
       ...
       if(password.value == confirmPassword.value){
        ...
        // If the form is not valid, prevent submission and show a message
